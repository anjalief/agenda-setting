...
def train(vocab_size, num_epochs, data, train_indices, test_indices, embedding_dim, hidden_dim):
...
def main():
    ...
    parser.add_argument('--monthly_gdp_file')
    parser.add_argument('--rtsi_file')
    ...
    for train_index, test_index in skf.split(data, article_dates):
        ...
        embedding_dim = 100
        hidden_dim = 100
#        train(vocab_size, epochs, data, train_index, test_index, embedding_dim, hidden_dim)
        break
